...
| 2026-06-27 | Rotada contraseña admin en BD + docs (Bb147232004 eliminada de README.md y DOCUMENTACION_TECNICA.md). Limpiado historial git con filter-repo + force push. Scripts .ps1 movidos a /scripts/. templates_backup/ ignorado. MAIL_SUPPRESS_SEND configurable por entorno. skills-lock.json y *.mwb agregados a .gitignore. | BD, README.md, DOCUMENTACION_TECNICA.md, .gitignore, app/__init__.py, scripts/ | Completado |
